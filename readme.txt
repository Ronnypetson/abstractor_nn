This project is about finding topologies of artificial neural networks with evolutionary search and training the individual models of every found form with backpropagation techniques. At the moment, this is restricted to supervised learning.
